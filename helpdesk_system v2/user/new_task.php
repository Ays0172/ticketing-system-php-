...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insert_stmt = $conn->prepare("
        INSERT INTO tasks (user_id, raised_by_name, designation, department_id, title, description, reference_no, status, file_path)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
    ");
    $insert_stmt->bind_param("sssssssss", $user_id, $name, $designation, $department_id, $title, $description, $reference_no, $status, $json_files);
